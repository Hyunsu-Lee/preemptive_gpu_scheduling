...
TRACE_EVENT(gpu_custom_ik,
        TP_PROTO(const char *func_name, u32 ctx_id, u64 atom_id, u64 data1, u64 data2, u64 data3, u64 data4, u64 data5, u64 data6, u64 data7, u64 data8, u64 data9),

        TP_ARGS(func_name, ctx_id, atom_id, data1, data2, data3, data4, data5, data6, data7, data8, data9),
        ...
        TP_printk("[%s](%lu, %llu): 0x%llx | 0x%llx | 0x%llx | 0x%llx | 0x%llx | 0x%llx | 0x%llx | 0x%llx | 0x%llx |",
            __get_str(func_name),
            (unsigned long)__entry->ctx_id,
            (unsigned long long)__entry->atom_id,
            (unsigned long long)__entry->data1,
            (unsigned long long)__entry->data2,
            (unsigned long long)__entry->data3,
            (unsigned long long)__entry->data4,
            (unsigned long long)__entry->data5,
            (unsigned long long)__entry->data6,
            (unsigned long long)__entry->data7,
            (unsigned long long)__entry->data8,
            (unsigned long long)__entry->data9
        )
);

/*
TRACE_EVENT(gpu_custom_print,
        TP_PROTO(const char*func_name, u64 timestamp, u32 ctx_id, u64 atom_id, u64 data1, u64 data2, u64 data3, u64 data4, u64 data5, u64 data6, u64 data7, u64 data8, u64 data9),
        TP_ARGS(func_name, timestamp, ctx_id, atom_id, data1, data2, data3, data4, data5, data6, data7, data8, data9),
        TP_STRUCT__entry(
            __string(   func_name, func_name    )
            __field(    u64, timestamp  )
            __field(    u32, ctx_id  )
        ...
        TP_printk("[%llu.%06lu] [%s](%lu, %llu): 1[%llx] 2[%llx] 3[%llx] 4[%llx] 5[%llx] 6[%llx] 7[%llx] 8[%llx] 9[%llx]",
		    (unsigned long long)show_secs_from_ns(__entry->timestamp),
    		(unsigned long)show_usecs_from_ns(__entry->timestamp),
            __get_str(func_name),
		    (unsigned long)__entry->ctx_id,
